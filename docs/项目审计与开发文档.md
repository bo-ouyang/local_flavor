...
GitHub Actions 质量门禁的实现与真实 Actions 验证已完成，但 PR #3 尚待合并，`main` 当前尚未具备该工作流。GitHub PR #3 的 Actions run [`30449577638`](https://github.com/bo-ouyang/local_flavor/actions/runs/30449577638) 已在 head `180e178` 上验证通过，4 个 jobs 均为 success。PR #3 中的工作流对指向 `main` 的 PR 与 `main` push 自动执行：
